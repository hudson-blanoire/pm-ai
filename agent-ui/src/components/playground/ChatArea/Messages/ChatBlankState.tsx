...
const EXTERNAL_LINKS = {
  documentation: 'https://github.com/phidatahq/agent-ui',
  playground: '',
  github: 'https://github.com/phidatahq/agent-ui'
}
        ...
        >
          <div className="flex items-center justify-center gap-x-2 whitespace-nowrap font-medium">
            <span className="flex items-center font-[600]">
              Welcome to the Mia Program Management Agent
            </span>
